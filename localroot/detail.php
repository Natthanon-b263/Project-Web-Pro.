...
$database_surachet = "surache1_621126";
$username_surachet = "surache1_621126";
$password_surachet = "KP9238AI";
...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="w3-content">
      ...
      <?php
             $id=$_GET['Id'];
             $sql_1 = "SELECT tbl_std_book.Id,tbl_std.Sname,tbl_std.Slastname,tbl_std_book.BookId,tbl_book.Book
                       FROM tbl_std JOIN tbl_std_book ON tbl_std.Id=tbl_std_book.Id 
                                    JOIN tbl_book ON tbl_book.BookID=tbl_std_book.BookID
                       WHERE tbl_std_book.Id='$id'  ";
